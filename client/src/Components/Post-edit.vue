    ...
    <div class="card-content">
      <div class="content">
        <div class="field">
          ...
          <div class="control">
            <input class="input" type="url"
              placeholder="Input URL to a picture"
            v-model="post.src"/>
          </div>
        </div>
         <div class="field">
          ...
          <div class="control">
            <input class="input" type="text"
              placeholder="Alternate Text for Picture"
            v-model="post.alt"/>
          </div>
        </div>
        ...
        <div class="field">
          ...
          <div class="control">
            <textarea class="textarea" placeholder="Explain This Picture" v-model="post.caption"></textarea>
          </div>
        </div>
